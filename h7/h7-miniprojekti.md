...
Projektin tarkoituksena on asentaa molemmille orjille kolme ohjelmaa: Discord, Firefox ja kuvankaappaustyökalu (ShareX ei ole saatavilla Ubuntulle, joten käytän sen tilalla Shutteria). Kotikoneella minulla on käytössä Windows 10 ja halusin kokeilla miten Saltin käyttö eroaa Ubuntu ja Windows koneilla.
